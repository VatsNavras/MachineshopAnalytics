...
.login-panel::before {
    ...
    top: 0; left: 0; right: 0;
    height: 3px;
    background: linear-gradient(90deg, #0d1f3c 0%, #2e8de8 50%, #cc1f24 100%);
    border-radius: 22px 22px 0 0;
}

/* Machinery watermark at bottom of card */
.login-panel::after {
    content: '⚙';
    position: absolute;
    bottom: -30px;
...
/* =========================================
   CLIENT LOGO TEXT (KISAAN DieTech)
========================================= */
